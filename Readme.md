...
### 1.2.1. Asignación aleatoria y grupo de control
...
### 1.2.3. Ejemplos de aplicación del libro
...
### 1.3.1. Hipótesis nula e hipótesis alternativa
...
### 1.3.2. Pruebas unilaterales y bilaterales
...
### 1.3.3. Ejemplo del libro: las rachas de una moneda
...
## 1.4. Interpretación de los temas
...
# 5. Multiple Testing (pruebas múltiples)
...
# 6. Degrees of Freedom (grados de libertad)
